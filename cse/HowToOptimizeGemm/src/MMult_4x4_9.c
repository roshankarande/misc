...
void AddDot4x4(int k, double *a, int lda, double *b, int ldb, double *c, int ldc)
{
  ...
  /* hold contributions to C( 0, 0 ), ...C( 0, 3 ), C( 1, 0 ) ...  C( 3, 3 ) */
  // hold A( 0, p ) ,  A( 1, p ) , A( 2, p ) , A( 3, p )
  // hold B( p, 0 ) ,  B( p, 1 ) , B( p, 2 ) , B( p, 3 )
  int p;
  ...
  double *b_p0_pntr, *b_p1_pntr, *b_p2_pntr, *b_p3_pntr; /* Point to the current elements in the four columns of B */
